...
$(document).on('click', '.estatus', function() {
    //https://localhost:8080/estatus_editorial/primaryKey/estatus 
	...
	let url = path +'/estatus_editorial/'+ id + '/' + estatus;
...
$(document).on('click', '.eliminar', function() {
     ...
     *             ];
     */
	let array = [' a la editorial ', 'Este acción será permanente.'];
	let url = path +'/eliminar_editorial/'+ id;
